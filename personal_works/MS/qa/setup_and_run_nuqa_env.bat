...
rem echo "input argument are %1 - mode (pre/norm) , %2 (qa folder) , %3 (model id)"
echo Setting DLL...
set ALTAIR_INSTALLATION=C:\Altair_Installs\2026_0_10_release\hwsolvers\motionsolve\bin\win64
...
rem set NUSOL_EXEC_DIR=%NUSOL_DLL_DIR%
...
nuqa qa_cmd\qa_depot_xml_tire.xml +%3 -%1